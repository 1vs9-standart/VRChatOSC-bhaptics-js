...
**Windows:** дважды нажми на `start.bat`
...
Перейди в браузере на **http://localhost:1969**
...
| `velocityMax` | 1.0–5.0 (3.0) | Макс. скорость. OSC иногда шлёт 1000+, ставь 3 |
| `durationMin` | 0–2 (0.2) | Мин. сила при долгом касании (объятия) |
| `durationMax` | 0–2 (1.3) | Макс. сила при долгом касании. Не больше maxIntensity |
| `longContactMs` | 500–5000 (1500) | За сколько мс плавное касание выходит на максимум |
| `emaAlpha` | 0.1–0.9 (0.4) | Сглаживание. Больше = быстрее реакция |
| `cooldownMs` | 20–100 (40) | Пауза (мс) между хаптиками при ударах |
| `sustainCooldownMs` | 100–500 (150) | Пауза при плавном касании |
| `minIntensity` | 0–2 (0.15) | Мин. сила (шкала bHaptics 0–2) |
| `maxIntensity` | 0–2 (2.0) | Макс. сила. VRChat: 1.8 чтобы не перегружать |
